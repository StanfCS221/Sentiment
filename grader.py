...
def test3b2():
    trainExamples = readExamples('C:\\Users\Young G\Desktop\Stnfd\sentiment\sentiment\polarity.train')
    devExamples = readExamples('C:\\Users\Young G\Desktop\Stnfd\sentiment\sentiment\polarity.dev')
    #featureExtractor = submission.extractWordFeatures
    featureExtractor = submission.extractCharacterFeatures(6)
    weights = submission.learnPredictor(trainExamples, devExamples, featureExtractor, numIters=20, eta=0.01)
    outputWeights(weights, 'weights.txt')
    outputErrorAnalysis(devExamples, featureExtractor, weights, 'deoTogTima.txt')  # Use this to debug
